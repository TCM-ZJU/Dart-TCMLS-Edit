	...
	function dateSelect(objname){
	  cc = document.getElementById('xxxxx');//
	  cc.style.visibility="visible";
	  cc.style.filter="Alpha(opacity=85)"
	  cc.style.left=document.body.scrollLeft+window.event.clientX-200;
